...
describe('VersionHistory', function() {
  ...
  it('returns release date for a given browser.', function() {
  ...
  it('throws error if the given browser is not in version history.',
    function() {
      expect(() => versionHistory.getReleaseDate('UC', '10.0'))
        .toThrow(new Error('UC not found in browser history.'));
    });
});
