...
xdescribe('WebAPIs', function() {
  ...
  xdescribe('ApiImporter', function() {
    apiImporter.import(webAPIs, 'Chrome', '56.0.2924.87',
  ...
  xdescribe('toMap_()', function() {
    let webAPIs = org.chromium.apis.web.WebAPIs.create();
    apiImporter.import(webAPIs, 'Chrome', '55', 'Window', '10', {
      'Array': ['find'],
      'Audio': ['stop'],
    });
    apiImporter.import(webAPIs, 'Edge', '14', 'Window', '10', {
      'Array': ['find'],
      'Audio': ['play'],
    });
    apiImporter.import(webAPIs, 'Safari', '10', 'OSX', '601', {
      'ApplePay': ['about'],
      'Audio': ['play', 'stop'],
      'Array': ['find'],
    });
    xdescribe('when all browser keys are selected', function() {
    ...
    xdescribe('when part of browser keys are selected', function() {
      ...
      it(`contains correct interface and API information`, function(done) {
        webAPIs.browserAPIs
          .where(M.IN(org.chromium.apis.web.BrowserAPI.BROWSER_KEY,
          [
            'Chrome_55_Window_10',
            'Edge_14_Window_10',
          ])).select()
  ...
  xdescribe('toMap()', function() {
    ...
    xdescribe('When all browsers are selected', function() {
      it(`contains all browser keys in header array`, function(done) {
        webAPIs.toMap([
          'Chrome_55_Window_10',
          'Edge_14_Window_10',
