...
foam.CLASS({
  ...
  properties: [
    ...
    },
    {
      ...
      of: 'org.chromium.apis.web.DAOFactory',
      name: 'remoteDAOFactory',
      factory: function() {
        this.validate();
        return this.RestDAOFactory.create({baseURL: this.baseURL});
      },
    },
    {
      name: 'delegate',
      ...
      factory: function() {
        ...
        return CachingDAO.create({
          of: this.of,
          src: this.remoteDAOFactory.create({of: this.of}, this.localCtx),
          cache,
        }, this.localCtx);
      },
    },
