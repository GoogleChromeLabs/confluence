  ...
  methods: [
    {
      ...
      args: [
        {
          ...
          documentation: `A string array contains valid browser keys. It will
            be used for filtering browserAPIs.`,
        },
      ],
      returns: {
        typeName: 'JSON',
      ...
      code: function(browserKeys) {
        return this.browserAPIs
          ...
          .select(this.M.GROUP_BY( this.BrowserAPI.INTERFACE_KEY,
            this.ArrayDAO.create()))
          .then((groups) => {
            let matrix = {};
