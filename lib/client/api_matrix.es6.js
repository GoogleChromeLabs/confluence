...
foam.CLASS({
  ...
  methods: [
          ...
          documentation: `An optional argument are used to filter the
            matrix result:
              ...
              browserOptions: An JSON of form {browserKey: boolean, ...}.
                ...
                in option.
              numAvailable: An integer or integer Array that the web
                interface An integer, or integer array. When set, only
    ...
    },
    {
      ...
      args: [
        {
          ...
          documentation: `A list of browsers this api supprts.`,
        },
        {
          name: 'numAvailable',
      ...
      returns: {
        typeName: 'Boolean',
        documentation: `A boolean value indicates if this API should be
          filtered.`,
      },
