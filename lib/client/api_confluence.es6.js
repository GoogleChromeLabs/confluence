...
foam.CLASS({
  ...
  methods: [
    ...
    },
    {
      ...
      code: function() {
        return this.failureToShipDAO.orderBy(
            this.FailureToShipData.DATE).select(this.mlang.GROUP_BY(
    ...
    },
    {
      ...
      code: function() {
        return this.vendorSpecificDAO.orderBy(
            this.VendorSpecificData.DATE).select(this.mlang.GROUP_BY(
    ...
    },
    {
      ...
      code: function() {
        return this.aggressiveRemovalDAO.orderBy(
            this.AggressiveRemovalData.DATE).select(this.mlang.GROUP_BY(
