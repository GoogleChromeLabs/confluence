...
foam.CLASS({
  ...
  methods: [
    ...
    },
    {
      ...
      documentation: `Read from failure to ship DAO and returns failure
        to ship metrics metric for each brwoser.`,
      returns: {
        typeName: 'JSON',
        documentation: `JSON of the form:
            {browserName: [
    ...
    },
    {
      ...
      documentation: `Read from vendor specific API dao and returns
        vendor specific metrics for each brwoser.`,
      returns: {
        typeName: 'JSON',
        documentation: `JSON of the form:
            {browserName:
