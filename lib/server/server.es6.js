...
foam.CLASS({
  ...
  methods: [
    function start() {
      ...
      this.addDir_('/fonts',
          this.path.resolve(__dirname, '../../static/fonts'));
      this.addDir_('/images',
      ...
      this.addFile_(
          '/materialize.css',
          this.path.resolve(__dirname, '../../static/materialize.css'));
      ...
      this.router.addPathname(
          `/${this.DAOContainer.COMPAT_MODEL_FILE_NAME}`,
      ...
      this.addDAORoute_(
          this.DAOContainer.LONE_OMISSION_NAME,
          this.browserMetricsDAO.where(EQ(TYPE, Type.LONE_OMISSION)));
      this.addDAORoute_(
          this.DAOContainer.BROWSER_SPECIFIC_NAME,
          this.browserMetricsDAO.where(EQ(TYPE, Type.BROWSER_SPECIFIC)));
      this.addDAORoute_(
          this.DAOContainer.LONE_REMOVAL_NAME,
          this.browserMetricsDAO.where(EQ(TYPE, Type.LONE_REMOVAL)));
      this.addDAORoute_(
          this.DAOContainer.API_COUNT_NAME, this.apiCountDAO);
