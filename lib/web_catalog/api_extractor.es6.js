  ...
  properties: [
    {
      ...
      class: 'Boolean',
      description: `When retainBuiltInMembers is true,
    ...
    },
    {
      ...
      class: 'Boolean',
      description: `When retainConstantMembers is false
        constant primitive properties are filtered.`,
      value: false,
    },
    {
      name: 'blacklistProperties',
      description: `Blacklisted properties that will not be visited or stored.`,
      class: 'StringArray',
      factory: function() {
        return [
    ...
    {
      name: 'rootId',
      description: `The root's id of the object graph.`,
      value: null,
    },
    {
      name: 'objectProtoId',
      description: `Object.prototype's id.`,
      value: null,
    },
    {
      name: 'functionProtoId',
      description: `Function.prototype's id.`,
      value: null,
    },
    {
      name: 'objectId',
  ...
  methods: [
    {
      ...
      description: `A wrapper function to get properties with constant,
        non-own-properties filtered.`,
      args: [
        {
          description: `The object graph.`,
          name: 'og',
          typeName: 'ObjectGraph',
        },
        {
          description: `The id of object whose properties will be returned.`,
          name: 'id',
          typeName: 'Number',
        },
      ],
      returns: {
        description: `A string array contains properties
    ...
    },
    {
      ...
      args: [
        {
          description: `The string that needs to be cleaned up.`,
          name: 'str',
          typeName: 'String',
        },
      ],
      returns: {
        description: `A string with special characters + and $ removed.`,
        typeName: 'String',
      },
      code: function(str) {
    ...
    },
    {
      ...
      args: [
        {
          description: `The string which needs to be checked.`,
          name: 'str',
          typeName: 'String',
        },
      ],
      returns: {
        description: `Return a boolean if the given string
    ...
    },
    {
      ...
      args: [
        {
          description: `The array will be merged into.`,
          name: 'arr',
          typeName: 'StringArray',
        },
        {
          description: `Array will be merged to the first array.`,
          name: 'StringArray',
        },
      ],
      code: function(arr) {
    ...
    },
    {
      ...
      args: [
        {
          description: `An array of API names.`,
          name: 'arr1',
          typeName: 'StringArray',
        },
        {
      ...
      returns: {
        description: `An arry which is arr1 set minus arr2`,
        typeName: 'StringArray',
      },
    ...
    },
    {
      ...
      description: `Get an array of properties from Function.prototype
    ...
    },
    {
      ...
      description: `Get an array of properties from Object.prototype
    ...
    },
    {
      ...
      args: [
        {
          description: `The id of object which it's class will be returned.`,
          name: 'id',
          typeName: 'Number',
        },
        {
      ...
      returns: {
        description: 'The class of object with given id.',
        typeName: 'String',
      },
      code: function(id, og) {
    ...
    },
    {
      ...
      args: [
        {
          description: `The json stores interface and API data.`,
          name: 'apiCatalog',
          typeName: 'JSON',
        },
        {
      ...
      code: function(apiCatalog, og) {
        for (let i = 0; i < this.blacklistProperties.length; i++) {
          ...
          if (apiCatalog[prop]) {
            delete apiCatalog[prop];
          }
        }
        // Add function and object blacklisted property
        // to Function and Object interface.
        if (!apiCatalog[og.getFunctionName(this.functionId)]) {
          apiCatalog[og.getFunctionName(this.functionId)] = [];
        }
        apiCatalog[og.getFunctionName(this.functionId)] =
          apiCatalog[og.getFunctionName(this.functionId)]
            .concat(this.builtInFunctionProperties);
        if (!apiCatalog[og.getFunctionName(this.objectId)]) {
          apiCatalog[og.getFunctionName(this.objectId)] = [];
        }
        apiCatalog[og.getFunctionName(this.objectId)] =
          apiCatalog[og.getFunctionName(this.objectId)]
            .concat(this.builtInObjectProperties);
      },
    },
    {
      name: 'extractAPI_',
      description: `extractAPI extracts API for interface with a given id.`,
      args: [
        {
          description: `The object graph.`,
          name: 'og',
        ...
        {
          description: `The json stores web api for different interface.`,
          name: 'map',
          typeName: 'JSON',
        },
        {
          description: `The id currently visiting.`,
          name: 'id',
          typeName: 'Number',
        },
        {
          description: `The property name from its parent node.`,
          name: 'name',
          typeName: 'String',
        },
        {
          description: `A map of visted objects.`,
          name: 'visited',
          typeName: 'JSON',
        },
        {
          description: `It stores additional infomation about this object.`,
          name: 'opt',
          options: [
            {
              name: `firstLevel`,
              typeName: 'Boolean',
              description: `If the object is a first level object.
            ...
            },
            {
              name: `proto`,
              typeName: 'Boolean',
              description: `If this object is a __proto__ of other object.
                False if undefined.`,
            },
          ],
        },
      ...
      code: function(og, map, id, name, visited, opt) {
        ...
        // first level objects.
        // First level objects are exceptions because we want to have
        // seprate interface for first level objects even if some of
        // them reference to the same object.
        ...
        // __proto__ is an object used in the lookup chain to resolve methods.
        // It should not contain instances,
        // thus do not visit __proto__'s property.
        if (proto) return;
    ...
    },
    {
      ...
      args: [
        {
          name: 'og',
          description: `The object graph where the
