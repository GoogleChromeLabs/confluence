  ...
  methods: [
    ...
    },
    {
      ...
      code: function(id, og) {
        ...
        // Ensure constructor property exists, and belongs this prototype.
        // See https://github.com/GoogleChrome/confluence/issues/210.
        if (ctorId && og.lookup('prototype', ctorId) === id) {
        ...
        if (og.isFunction(id) && (proto || firstLevel)) {
          ...
          if (this.setMinus_(ownProperty,
            ...
            if (((!className) || className === 'Object') && firstLevel) {
              ...
              let prototypePropertyId = og.lookup('prototype', id);
              // In Firefox, Edge, and Safari (at least),
              // objects can have prototype properties.
              let prototypePropertyProps = [];
              if (prototypePropertyId) {
                // Capture all APIs descending from <current object>.prototype
                // that do not belong to a different interface.
                //
                // Walk the prototype chain of <current object>.prototype until:
                // (1) the prototype's class name changes (i.e., prototype
                //     belongs to another API; OR
                // (2) Object.prototype is reached (this is necessary because
                //     the current class name may be "Object").
