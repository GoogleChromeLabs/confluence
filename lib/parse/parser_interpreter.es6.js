...
foam.CLASS({
  ...
  implements: [
    ...
    'org.mozilla.parse.QueryInterpreter',
  ],
  ...
  documentation: `Interpreter for handling release key matching and
      ...
      chr60:t => [prefix match alphabetical and numeric groups]
              => "Shipped (t for false) in Chrome 60 on all known platforms"`,
  ...
  methods: [
    function interpretKeyValue(key, value, parser) {
      ...
      // Starts with 't' or non-zero digit => true;
      // Starts with 'f' or '0' => false;
      // Otherwise pass to delegate.
