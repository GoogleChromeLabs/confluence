...
angular.module('confluence')
  .controller('confluenceController', ['$scope', 'api', function($scope, api) {
    ...
    // TODO(markdittmer): ApiMatrix with runInParallel=false may drop rapid
    // requests for new matrix views. Either switch to runInParallel=true or
    // constrain UI to have just one Catalog view on the Confluence page.
