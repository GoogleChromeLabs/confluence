...
foam.CLASS({
  ...
  documentation: `WebAPIs is the main model of this project. It have a
    browserAPIs property which is a FOAM DAO. It contains every browser
    and interface information for recent 2 years. It have methods to
    transform the data model from Google Cloud Datastore to CSV format
    String or JSON structure to be displayed in client side. It also
    have methods to do data analysis.`,
  requires: [
  ...
  methods: [
    ...
    },
    {
      ...
      documentation: `Takes an array of browser keys, produce a JSON containing
        browser and interface relationship. This structure should be easy to be
        displayed as a nested table in client side.`,
      args: [
        {
          name: 'browserKeys',
          typeName: 'StringArray',
