...
foam.CLASS({
  ...
  exports: [
    ...
    'releaseApiDAO as releaseWebInterfaceJunctionDAO',
  ],
  properties: [
    {
      name: 'releaseApiDAO',
      documentation: `A DAO that contains pairs of release
        and web interface.`,
      factory: function() {
    ...
    {
      name: 'releaseDAO',
      documentation: `A DAO that contains release names, versions
        OS, OS versions and its release key.`,
      factory: function() {
        return this.EasyDAO.create({
          name: 'releaseDAO',
          of: this.Release,
      ...
      code: function(browserName, browserVersion,
        ...
        for (let i = 0; i < interfaceNames.length; i++) {
          ...
          for (let j = 0; j < apiCatalog[interfaceName].length; j++) {
            ...
            promises.push(webInterface.releases.put(release));
          }
        }
