...
foam.CLASS({
  ...
  documentation: `Singleton that encapsulates logic for generating a compat
  ...
  methods: [
    ...
    },
    {
      ...
      documentation: `Produce a consistent camelCase property name from a
          release object. The property is used to store compat data for the
          release.`,
