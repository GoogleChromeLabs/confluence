  ...
  properties: [
    ...
    },
    {
      ...
      factory: function() {
        ...
        apiImporter.browserApiDAO = this.RateLimitedDAO.create({
        ...
        apiImporter.browserDAO = this.RateLimitedDAO.create({
          delegate: this.DatastoreDAO.create(
            Object.assign({
              of: this.Browser,
            }, config)
        ...
        apiImporter.interfaceDAO = this.RateLimitedDAO.create({
          delegate: this.DatastoreDAO.create(
            Object.assign({
