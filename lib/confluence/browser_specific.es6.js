  ...
  methods: [
    ...
    },
    {
      ...
      code: function(releases, date, release) {
        ...
        // browser, that were released during the grace pariod.
        const comparedReleases = this.releaseDAO.where(
            this.AND(
                // LTE: Include other releases on the same date as "rlease".
    ...
    },
    {
      ...
      code: function(comparedReleases, prevReleases, date, release) {
        ...
        // i.e.,
        //
        // INSERSECT(<interfaces of browser-of-interest from grace period>)
