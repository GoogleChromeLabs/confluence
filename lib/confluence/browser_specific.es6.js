  ...
  methods: [
    {
      ...
      code: function(releases, date) {
        this.info('Browser-Specific: Starting compute');
    ...
    },
    {
      ...
      code: function(releases, date, release) {
        this.info(
          'Browser-Specific: Starting compute for date ' + date +
            '\n    release: ' + release.id);
    ...
    },
    {
      ...
      code: function(comparedReleases, prevReleases, date, release) {
        ...
        this.info(
            'Browser-Specific: Starting compute for date ' + date +
            '\n    release: ' + release.id +
            '\n    compared: ' + comparedReleases.length +
            '\n    previous: ' + prevReleases.length);
