...
foam.CLASS({
  ...
  methods: [
    ...
    function find(key) {
      return new Promise((resolve, reject) => {
        ...
        const onFind = this.onFind.bind(this, data);
        const onError = this.onFindError.bind(this, data);
    ...
    function select(opt_sink, skip, limit, order, predicate) {
      const sink = opt_sink || this.ArraySink.create();
      ...
      return new Promise((resolve, reject) => {
        ...
        const onSelect = this.onSelect.bind(this, data);
        const onError = this.onSelectError.bind(this, data);
  ...
  listeners: [
    function onFind(data, o) {
      ...
      const shouldResolve = data.found === null || o !== null;
      data.found = o;
