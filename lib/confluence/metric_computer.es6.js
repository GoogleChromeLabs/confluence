...
foam.CLASS({
  ...
  methods: [
    ...
    {
      name: 'compute',
      documentation: `Compute a date-bound vendor-specific metric datum for each
          vendor.
          ...
          Firefox, and Edge; the values are associated with browser releases
          "as of 2017-01-01".`,
      args: [
        {
          name: 'browsers',
          typeName: 'org.chromium.apis.web.Browser[]',
          documentation: 'The latest browser from each vendor as of "date".',
        },
        {
          name: 'date',
          typeName: 'Date',
          documentation: `The date for which each vendor-specific datum will is
              to be computed.`,
        },
      ],
