...
foam.CLASS({
  ...
  documentation: `cloud store importer handles importing browserAPIs
    from object graph files to a google cloud datastore.`,
  requires: [
      ...
      code: function() {
        ...
        for (let i = 0; i < ogFiles.length; i++) {
          ...
          if (stat.isFile()) {
            ...
            this.apiImporter.import(browserInfo[1], browserInfo[2],
              browserInfo[3], browserInfo[4],
              this.extractor.extractWebCatalog(objectGraph
